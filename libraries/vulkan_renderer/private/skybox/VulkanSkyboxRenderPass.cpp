...
void
VulkanSkyboxRenderPass::resize(VulkanSwapChain const &swapChain)
{
    clear();
    _create_render_pass(swapChain);
    _create_depth_resources(swapChain);
...
void
VulkanSkyboxRenderPass::_create_render_pass(VulkanSwapChain const &swapChain)
{
    // Color
...
void
VulkanSkyboxRenderPass::_create_framebuffers(VulkanSwapChain const &swapChain)
{
    ...
    for (auto const &it : swapChain.swapChainImageViews) {
        ...
        if (vkCreateFramebuffer(
            ...
            VK_SUCCESS) {
            throw std::runtime_error(
              "VulkanSkyboxRenderPass: Failed to create framebuffer");
        }
        ++i;
    }
}